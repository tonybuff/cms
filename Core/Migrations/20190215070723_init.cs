        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Users_CreatedByUserGuid",
                        column: x => x.CreatedByUserGuid,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Users_Users_ModifiedByUserGuid",
                        column: x => x.ModifiedByUserGuid,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_CreatedByUserGuid",
                table: "Users",
                column: "CreatedByUserGuid",
                unique: true,
                filter: "[CreatedByUserGuid] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Users_ModifiedByUserGuid",
                table: "Users",
                column: "ModifiedByUserGuid",
                unique: true,
                filter: "[ModifiedByUserGuid] IS NOT NULL");
